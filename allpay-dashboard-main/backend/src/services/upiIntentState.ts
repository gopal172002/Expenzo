import type { UpiIntentStatus } from "../models";
...
export function isUpiIntentStatus(value: string): value is UpiIntentStatus {
  return value in ALLOWED;
}

export function canTransitionUpiStatus(from: UpiIntentStatus, to: UpiIntentStatus): boolean {
